    ...
    return [
      {
        ...
        getAttrs: (element) => {
          ...
          const hex = rgb?.map((value: string) => {
    ...
    return [
      ...
      [
        ...
        [
          "td",
          {
            style: `width: ${node.attrs.percent}%; background-color: ${colorMap[node.attrs.color as colors]}; border-top-left-radius: 8px; border-bottom-left-radius: 8px;`,
          },
        ],
        [
          "td",
          {
            style: `width: ${100 - node.attrs.percent}%; background-color: #f5f5f5; border-top-right-radius: 8px; border-bottom-right-radius: 8px;`,
          },
        ],
      ],
    ];
