  ...
  return (
    <div className={"flex min-h-screen w-screen flex-col items-center justify-center gap-6"}>
      <div className={"text-center"}>
        ...
        <p className="mx-auto mt-2 text-lg text-neutral-500">Don't worry! You can use both, but we recommend starting with one.</p>
      </div>
      <div className={"grid gap-6 p-3 sm:grid-cols-2"}>
        <div className={"flex flex-col items-center gap-6 rounded-md border border-neutral-200 bg-white px-12 py-6 text-center"}>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className={"flex items-center gap-x-0.5 rounded-md bg-neutral-800 px-10 py-2.5 text-center text-sm font-medium text-white sm:col-span-2"}
          >
        ...
        <div className={"flex flex-col items-center gap-6 rounded-md border border-neutral-200 bg-white px-12 py-6 text-center"}>
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.9 }}
            className={"mx-auto flex items-center gap-x-0.5 rounded-md bg-neutral-800 px-10 py-2.5 text-center text-sm font-medium text-white sm:col-span-2"}
          >
