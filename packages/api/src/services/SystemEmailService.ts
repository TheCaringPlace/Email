...
Please click the link below to accept the invitation and create your account: ${emailConfig.appUrl}/auth/signup`,
    });
  }
...
If you did request this, please click the link below to reset your password: ${emailConfig.appUrl}/auth/reset?code=${code}&email=${encodeURIComponent(email)}
...
Please click the link below to verify your email and activate your account: ${emailConfig.appUrl}/auth/verify?code=${code}&email=${encodeURIComponent(email)}
